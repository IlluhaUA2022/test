    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div class="grid gap-10 lg:grid-cols-2">
        <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
          <div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-green-10">
          ...
          <div class="max-w-xl mb-6">
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
              ...
              your next
              <span class="inline-block text-sky-400">destination1</span>
            </h2>
            <p class="text-base text-gray-700 md:text-lg">
               Corporis dolorem eos ipsum maiores natus nulla odio odit porro quas vel!
            </p>
          </div>
          <div>
            <a href="http://localhost:3000/blog" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-sky-400 hover:text-sky-800">
              Learn more
